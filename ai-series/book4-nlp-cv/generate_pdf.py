...
NLP & Computer Vision (Book 4 of the AI Series) - PDF Generator
"""
...
# ─── Colors (Teal theme) ───
DARK_BLUE = HexColor('#134e4a')
MEDIUM_BLUE = HexColor('#0d9488')
LIGHT_BLUE = HexColor('#f0fdfa')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#0d9488">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book4-nlp-cv/manuscript'
CHAPTER_FOLDERS = [
    '01-what-is-nlp',
    ...
    '14-text-generation',
    '15-multilingual-nlp',
    '16-image-fundamentals',
    '17-image-preprocessing',
    '18-image-classification-cnn',
    '19-transfer-learning-vision',
    '20-object-detection',
    '21-image-segmentation',
    '22-face-detection',
    '23-vision-transformers',
    '24-ocr',
    '25-project-sentiment-api',
    '26-project-document-classifier',
    '27-project-image-app',
    '28-project-object-detection',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'NLP & Computer Vision')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('NLP &amp; Computer Vision', styles['BookTitle']))
    flowables.append(Paragraph('Book 4 of the AI Series', styles['BookSubtitle']))
    ...
    flowables.append(Paragraph(
        'Master Language and Vision AI',
        subtitle_style
    ))
    flowables.append(Spacer(1, 0.3 * inch))
    flowables.append(Paragraph(
        'With Hugging Face, PyTorch, and YOLO',
        subtitle_style
    ))
    ...
    flowables.append(Paragraph('2025 Edition &bull; 28 Chapters', edition_style))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('16', 'Image Fundamentals'),
        ('17', 'Image Preprocessing'),
        ('18', 'Image Classification with CNNs'),
        ('19', 'Transfer Learning for Vision'),
        ('20', 'Object Detection'),
        ('21', 'Image Segmentation'),
        ('22', 'Face Detection'),
        ('23', 'Vision Transformers'),
        ('24', 'OCR'),
        ('25', 'Project: Sentiment Analysis API'),
        ('26', 'Project: Document Classifier'),
        ('27', 'Project: Image Application'),
        ('28', 'Project: Object Detection'),
    ]
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book4-nlp-cv/build',
        'NLP_Computer_Vision.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        author='AI Series',
        subject='Natural Language Processing and Computer Vision',
    )
    ...
    for idx, folder in enumerate(CHAPTER_FOLDERS):
        ...
        print(f"Processing chapter {idx + 1}/28: {folder}...")
