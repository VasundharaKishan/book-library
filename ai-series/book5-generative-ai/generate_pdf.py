...
Generative AI & LLMs - Book 5 of the AI Series - PDF Generator
"""
...
# ─── Colors ───
DARK_BLUE = HexColor('#831843')
MEDIUM_BLUE = HexColor('#db2777')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#db2777">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book5-generative-ai/manuscript'
CHAPTER_FOLDERS = [
    '01-what-are-llms',
    '02-how-llms-work',
    '03-key-models',
    ...
    '17-rag-pipeline',
    '18-advanced-rag',
    '19-finetune-vs-prompt-vs-rag',
    '20-training-data',
    '21-lora-qlora',
    '22-finetuning-practice',
    '23-what-are-agents',
    '24-function-calling',
    '25-langchain-agents',
    '26-multi-agent',
    '27-multimodal-ai',
    '28-project-rag-chatbot',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Generative AI & LLMs')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Generative AI &amp; LLMs', styles['BookTitle']))
    flowables.append(Paragraph('Book 5 of the AI Series', styles['BookSubtitle']))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('17', 'RAG Pipeline'),
        ('18', 'Advanced RAG'),
        ('19', 'Fine-Tune vs Prompt vs RAG'),
        ('20', 'Training Data'),
        ('21', 'LoRA and QLoRA'),
        ('22', 'Fine-Tuning in Practice'),
        ('23', 'What Are Agents'),
        ('24', 'Function Calling'),
        ('25', 'LangChain Agents'),
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book5-generative-ai/build',
        'Generative_AI_LLMs.pdf'
    )
