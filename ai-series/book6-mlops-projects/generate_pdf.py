...
MLOps, Ethics & Career - Book 6 of the AI Series - PDF Generator
"""
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#475569">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book6-mlops-projects/manuscript'
CHAPTER_FOLDERS = [
    '01-notebook-to-production',
    '02-saving-loading-models',
    '03-fastapi-ml',
    '04-docker',
    '05-cloud-deployment',
    '06-streamlit-gradio',
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'MLOps, Ethics & Career')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('MLOps, Ethics &amp; Career', styles['BookTitle']))
    flowables.append(Paragraph('Book 6 of the AI Series', styles['BookSubtitle']))
    ...
    flowables.append(Paragraph(
        'Deploy, Monitor, and Scale AI Systems Responsibly',
        subtitle_style
    ))
    flowables.append(Spacer(1, 2.5 * inch))
    ...
    flowables.append(Paragraph('2025 Edition &bull; 25 Chapters', edition_style))
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book6-mlops-projects/build',
        'MLOps_Ethics_Career.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=1 * inch,
        rightMargin=1 * inch,
        title='MLOps, Ethics & Career',
        author='AI Series',
        subject='MLOps, AI Ethics, and Career Development',
    )
    ...
    for idx, folder in enumerate(CHAPTER_FOLDERS):
        ...
        print(f"Processing chapter {idx + 1}/25: {folder}...")
