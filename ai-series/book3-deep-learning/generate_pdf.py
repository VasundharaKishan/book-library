...
Deep Learning with PyTorch - PDF Generator
"""
...
# ─── Colors (Purple scheme) ───
DARK_BLUE = HexColor('#2d1054')
MEDIUM_BLUE = HexColor('#7c3aed')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#7c3aed">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book3-deep-learning/manuscript'
CHAPTER_FOLDERS = [
    '01-what-is-deep-learning',
    '02-perceptron',
    '03-multilayer-networks',
    ...
    '27-saving-deploying',
    '28-debugging-dl',
    '29-project-image-classifier',
    '30-project-sentiment',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Deep Learning with PyTorch')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Deep Learning with PyTorch', styles['BookTitle']))
    flowables.append(Paragraph('Book 3 of the AI Series', styles['BookSubtitle']))
    ...
    flowables.append(Paragraph(
        'From Neurons to Transformers &mdash; Build Neural Networks from Scratch with PyTorch',
        subtitle_style
    ))
    flowables.append(Spacer(1, 0.3 * inch))
    flowables.append(Paragraph(
        'CNNs &bull; RNNs &bull; Transformers &bull; GANs &bull; Autoencoders',
        subtitle_style
    ))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('20', 'Attention Mechanism'),
        ('21', 'The Transformer'),
        ('22', 'Transformers in PyTorch'),
        ('23', 'Autoencoders'),
        ('24', 'Variational Autoencoders'),
        ('25', 'Generative Adversarial Networks'),
        ('26', 'GANs in PyTorch'),
        ('27', 'Saving and Deploying Models'),
        ('28', 'Debugging Deep Learning'),
        ('29', 'Project: Image Classifier'),
        ('30', 'Project: Sentiment Analysis'),
    ]
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book3-deep-learning/build',
        'Deep_Learning_PyTorch.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        author='Deep Learning with PyTorch',
        subject='Deep Learning and Neural Networks with PyTorch',
    )
