...
Data Science & Machine Learning - PDF Generator
"""
...
# ─── Colors ───
DARK_BLUE = HexColor('#4a2800')
MEDIUM_BLUE = HexColor('#e67e22')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#e67e22">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book2-data-science-ml/manuscript'
CHAPTER_FOLDERS = [
    '01-what-is-ml',
    '02-data-collection',
    '03-eda',
    ...
    '18-naive-bayes',
    '19-kmeans',
    '20-hierarchical-dbscan',
    '21-anomaly-detection',
    '22-association-rules',
    '23-eval-regression',
    '24-eval-classification',
    '25-cross-validation',
    '26-hyperparameter-tuning',
    '27-sklearn-pipelines',
    '28-imbalanced-data',
    '29-project-house-prices',
    '30-project-churn',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Data Science & Machine Learning')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Data Science &amp; Machine Learning', styles['BookTitle']))
    flowables.append(Paragraph('Book 2 of the AI Series', styles['BookSubtitle']))
    ...
    flowables.append(Paragraph(
        'Master Machine Learning from Data to Deployment -- With Scikit-Learn and Python',
        subtitle_style
    ))
    flowables.append(Spacer(1, 0.3 * inch))
    flowables.append(Paragraph(
        'Supervised &bull; Unsupervised &bull; Evaluation &bull; Deployment',
        subtitle_style
    ))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('20', 'Hierarchical Clustering and DBSCAN'),
        ('21', 'Anomaly Detection'),
        ('22', 'Association Rules'),
        ('23', 'Evaluating Regression Models'),
        ('24', 'Evaluating Classification Models'),
        ('25', 'Cross-Validation'),
        ('26', 'Hyperparameter Tuning'),
        ('27', 'Scikit-Learn Pipelines'),
        ('28', 'Handling Imbalanced Data'),
        ('29', 'Project: House Price Prediction'),
        ('30', 'Project: Customer Churn Prediction'),
    ]
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/ai-series/book2-data-science-ml/build',
        'Data_Science_ML.pdf'
    )
