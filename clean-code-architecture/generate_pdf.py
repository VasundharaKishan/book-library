...
Clean Code & Software Architecture - PDF Generator
"""
...
# ─── Colors (amber/warm theme) ───
DARK_BLUE = HexColor('#78350f')
MEDIUM_BLUE = HexColor('#d97706')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#d97706">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/clean-code-architecture/manuscript'
CHAPTER_FOLDERS = [
    '01-why-clean-code',
    '02-meaningful-names',
    '03-functions',
    ...
    '06-error-handling',
    '07-classes',
    '08-solid-single-responsibility',
    '09-solid-open-closed',
    '10-solid-liskov',
    '11-solid-interface-segregation',
    '12-solid-dependency-inversion',
    '13-dry-kiss-yagni',
    '14-code-smells',
    '15-refactoring-techniques',
    '16-unit-testing-principles',
    '17-test-driven-development',
    '18-clean-architecture-intro',
    '19-layered-architecture',
    '20-hexagonal-architecture',
    '21-onion-architecture',
    ...
    '28-technical-debt',
    '29-code-review-culture',
    '30-legacy-code',
    '31-project-refactoring',
    '32-glossary',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Clean Code & Software Architecture')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Clean Code &amp; Software Architecture', styles['BookTitle']))
    ...
    flowables.append(Paragraph(
        'Write Maintainable Code and Design Scalable Systems -- With Java and Python',
        subtitle_style
    ))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('11', 'SOLID: Interface Segregation Principle'),
        ('12', 'SOLID: Dependency Inversion Principle'),
        ('13', 'DRY, KISS, and YAGNI'),
        ('14', 'Code Smells'),
        ('15', 'Refactoring Techniques'),
        ('16', 'Unit Testing Principles'),
        ('17', 'Test-Driven Development'),
        ('18', 'Clean Architecture Introduction'),
        ('19', 'Layered Architecture'),
        ('20', 'Hexagonal Architecture'),
        ('21', 'Onion Architecture'),
        ('22', 'Domain-Driven Design'),
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/clean-code-architecture/build',
        'Clean_Code_Architecture.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        author='Clean Code & Software Architecture Book',
        subject='Clean Code and Software Architecture',
    )
