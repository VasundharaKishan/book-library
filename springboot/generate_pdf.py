...
Spring Boot 3: A Complete Guide - PDF Generator
"""
...
DARK_BLUE = HexColor('#1a472a')
MEDIUM_BLUE = HexColor('#2d8a4e')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#2d8a4e">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/springboot/manuscript'
CHAPTER_FOLDERS = [
    '01-what-is-spring-boot',
    '02-development-environment',
    '03-first-spring-boot-project',
    '04-project-structure',
    '05-auto-configuration',
    '06-dependency-injection',
    '07-beans-and-annotations',
    '08-properties-and-profiles',
    '09-first-rest-controller',
    '10-request-response-handling',
    '11-input-validation',
    '12-exception-handling',
    '13-interceptors-and-filters',
    '14-spring-data-jpa-and-h2',
    '15-repositories-and-crud',
    '16-pagination-and-sorting',
    '17-spring-security-intro',
    '18-jwt-authentication',
    '19-password-encoding-roles',
    ...
    '28-actuator-monitoring',
    '29-externalized-configuration',
    '30-docker-and-deployment',
    'appendix-a-websocket',
    'appendix-b-complete-project',
    'appendix-c-glossary',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Spring Boot 3: A Complete Guide')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Spring Boot 3', styles['BookTitle']))
    ...
    flowables.append(Paragraph(
        'From Zero to Production-Ready REST APIs -- With Java 17+ and Spring Boot 3.4',
        subtitle_style
    ))
    flowables.append(Spacer(1, 2.5 * inch))
    ...
    flowables.append(Paragraph('2025 Edition &bull; 30 Chapters + 3 Appendices', edition_style))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('7', 'Beans and Annotations'),
        ('8', 'Properties and Profiles'),
        ('9', 'First REST Controller'),
        ...
        ('15', 'Repositories and CRUD'),
        ('16', 'Pagination and Sorting'),
        ('17', 'Spring Security Introduction'),
        ('18', 'JWT Authentication'),
        ('19', 'Password Encoding and Roles'),
        ('20', 'CORS Configuration'),
    ...
    appendix_names = [
        ...
        ('B', 'Complete Project Walkthrough'),
        ('C', 'Glossary'),
    ]
    for letter_id, name in appendix_names:
        toc_style = ParagraphStyle(
            f'TOC_App_{letter_id}',
            parent=styles['Normal'],
            fontSize=12,
            leading=20,
            textColor=DARK_GRAY,
        ...
        flowables.append(Paragraph(
            f'<b>Appendix {letter_id}</b> &mdash; {name}',
            toc_style
        ))
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/springboot/build',
        'Spring_Boot_Complete_Guide.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=1 * inch,
        rightMargin=1 * inch,
        title='Spring Boot 3: A Complete Guide',
        author='Spring Boot Book',
        subject='Spring Boot Development',
    )
    ...
    for idx, folder in enumerate(CHAPTER_FOLDERS):
        ...
        print(f"Processing chapter {idx + 1}/{total_chapters}: {folder}...")
