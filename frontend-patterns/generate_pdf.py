...
Frontend Design Patterns - PDF Generator
"""
...
# ─── Colors ───
DARK_BLUE = HexColor('#312e81')
MEDIUM_BLUE = HexColor('#6366f1')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#6366f1">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/frontend-patterns/manuscript'
CHAPTER_FOLDERS = [
    ...
    '15-container-presentational',
    '16-higher-order-components',
    '17-render-props',
    '18-custom-hooks-pattern',
    '19-compound-components',
    '20-controlled-uncontrolled',
    '21-provider-pattern',
    '22-state-reducer-pattern',
    '23-state-machine-pattern',
    '24-flux-redux-pattern',
    '25-rendering-patterns',
    '26-code-splitting-lazy',
    '27-virtualization-pattern',
    '28-memoization-pattern',
    '29-error-boundary-pattern',
    '30-micro-frontends',
    '31-project-pattern-library',
    '32-glossary',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Frontend Design Patterns')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Frontend Design Patterns', styles['BookTitle']))
    ...
    flowables.append(Paragraph(
        'Master JavaScript and React Patterns for Scalable Applications',
        subtitle_style
    ))
    flowables.append(Spacer(1, 0.3 * inch))
    flowables.append(Paragraph(
        'Design Patterns &bull; Component Patterns &bull; Architecture',
        subtitle_style
    ))
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/frontend-patterns/build',
        'Frontend_Design_Patterns.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=1 * inch,
        rightMargin=1 * inch,
        title='Frontend Design Patterns: A Complete Guide',
        author='Frontend Design Patterns Book',
        subject='Frontend Design Patterns',
    )
