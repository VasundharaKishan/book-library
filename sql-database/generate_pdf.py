...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph(
        'Master SQL Queries, Database Design, and Performance -- With PostgreSQL',
        subtitle_style
    ))
    flowables.append(Spacer(1, 0.3 * inch))
    ...
    flowables.append(Paragraph('2025 Edition &bull; 34 Chapters', edition_style))
...
def main():
    ...
    for idx, folder in enumerate(CHAPTER_FOLDERS):
        ...
        print(f"Processing chapter {idx + 1}/34: {folder}...")
