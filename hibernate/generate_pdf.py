...
Hibernate & JPA: A Complete Guide - PDF Generator
"""
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#2b8a3e">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/hibernate/manuscript'
CHAPTER_FOLDERS = [
    '01-introduction',
    ...
    '17-entity-lifecycle',
    '18-fetching-strategies',
    '19-cascade-operations',
    '20-transaction-management',
    '21-caching',
    '22-bean-validation',
    '23-dtos-projections',
    '24-repository-service-layer',
    '25-error-handling',
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Hibernate & JPA: A Complete Guide')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Hibernate &amp; JPA', styles['BookTitle']))
    ...
    flowables.append(Paragraph(
        'From First Entity to Production Application &mdash; With Spring Boot 3, Hibernate 6, and Jakarta Persistence',
        subtitle_style
    ))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('21', 'Caching'),
        ('22', 'Bean Validation'),
        ('23', 'DTOs and Projections'),
        ('24', 'Repository and Service Layer'),
        ('25', 'Error Handling'),
        ('26', 'Flyway Migrations'),
        ('27', 'Performance Tuning'),
        ('28', 'REST API'),
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/hibernate/build',
        'Hibernate_JPA_Complete_Guide.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=1 * inch,
        rightMargin=1 * inch,
        title='Hibernate & JPA: A Complete Guide',
        author='Hibernate & JPA Book',
        subject='Hibernate and JPA Development',
    )
