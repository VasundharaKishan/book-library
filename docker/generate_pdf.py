...
Docker & Kubernetes: A Complete Guide - PDF Generator
"""
...
# ─── Colors ───
DARK_BLUE = HexColor('#064e3b')
MEDIUM_BLUE = HexColor('#059669')
...
def format_inline(text):
    ...
    def replace_code(m):
        ...
        code_placeholders[key] = '<font name="' + CODE_FONT + '" size="9" color="#059669">' + m.group(1) + '</font>'
        counter[0] += 1
        return key
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/docker/manuscript'
CHAPTER_FOLDERS = [
    '01-what-is-docker',
    '02-installing-docker',
    '03-first-container',
    '04-how-containers-work',
    '05-docker-images',
    '06-first-dockerfile',
    '07-dockerfile-best-practices',
    '08-real-app-images',
    '09-container-lifecycle',
    '10-env-vars-config',
    '11-volumes',
    '12-networking',
    '13-logs-debugging',
    ...
    '16-compose-networking-volumes',
    '17-compose-development',
    '18-compose-in-practice',
    '19-docker-hub-registries',
    '20-image-tagging',
    '21-cicd-docker',
    '22-docker-security',
    '23-docker-production',
    '24-docker-swarm',
    '25-optimizing-images',
    '26-what-is-kubernetes',
    '27-kubernetes-setup',
    '28-pods-deployments-services',
    '29-configmaps-secrets-volumes',
    '30-deploy-real-app-k8s',
    '31-appendix-cheat-sheet',
    '32-appendix-project',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Docker & Kubernetes: A Complete Guide')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Docker &amp; Kubernetes', styles['BookTitle']))
    ...
    flowables.append(Paragraph(
        'From First Container to Production Deployment -- With Docker Compose and Kubernetes',
        subtitle_style
    ))
    flowables.append(Spacer(1, 0.3 * inch))
    flowables.append(Paragraph(
        'Containers &bull; Compose &bull; Orchestration',
        subtitle_style
    ))
    ...
    flowables.append(Paragraph('2025 Edition &bull; 32 Chapters', edition_style))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('5', 'Docker Images'),
        ('6', 'Your First Dockerfile'),
        ('7', 'Dockerfile Best Practices'),
        ('8', 'Building Real App Images'),
        ('9', 'Container Lifecycle'),
        ('10', 'Environment Variables and Configuration'),
        ('11', 'Volumes'),
        ('12', 'Networking'),
        ('13', 'Logs and Debugging'),
        ('14', 'Introduction to Docker Compose'),
        ('15', 'Multi-Container Applications'),
        ('16', 'Compose Networking and Volumes'),
        ('17', 'Compose for Development'),
        ('18', 'Compose in Practice'),
        ('19', 'Docker Hub and Registries'),
        ('20', 'Image Tagging'),
        ('21', 'CI/CD with Docker'),
        ('22', 'Docker Security'),
        ...
        ('26', 'What Is Kubernetes?'),
        ('27', 'Kubernetes Setup'),
        ('28', 'Pods, Deployments, and Services'),
        ('29', 'ConfigMaps, Secrets, and Volumes'),
        ('30', 'Deploy a Real App to Kubernetes'),
        ('31', 'Appendix: Cheat Sheet'),
        ('32', 'Appendix: Project'),
    ]
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/docker/build',
        'Docker_Kubernetes_Guide.pdf'
    )
    ...
    for idx, folder in enumerate(CHAPTER_FOLDERS):
        ...
        print(f"Processing chapter {idx + 1}/32: {folder}...")
