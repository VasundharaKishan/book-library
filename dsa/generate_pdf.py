...
Data Structures & Algorithms: A Complete Guide - PDF Generator
"""
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/dsa/manuscript'
CHAPTER_FOLDERS = [
    '01-what-is-dsa',
    '02-big-o-notation',
    '03-arrays',
    ...
    '30-interview-strategies',
    '31-project-50-problems',
    '32-glossary',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Data Structures & Algorithms: A Complete Guide')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Data Structures &amp; Algorithms', styles['BookTitle']))
    ...
    flowables.append(Paragraph(
        'Master Every Data Structure and Algorithm -- With Python and Java',
        subtitle_style
    ))
    flowables.append(Spacer(1, 2.5 * inch))
...
def build_toc_page(styles):
    ...
    chapter_names = [
        ...
        ('9', 'Recursion'),
        ('10', 'Sorting: Bubble, Selection, Insertion'),
        ('11', 'Sorting: Merge Sort and Quick Sort'),
        ('12', 'Binary Search'),
        ('13', 'Trees: Basics'),
        ('14', 'Binary Search Trees'),
        ('15', 'Tree Traversals'),
        ('16', 'Heaps'),
        ('17', 'Graphs: Basics'),
        ('18', 'Graph Traversal: BFS and DFS'),
        ('19', 'Shortest Path Algorithms'),
        ('20', 'Dynamic Programming: Introduction'),
        ('21', 'DP Patterns'),
        ('22', 'Greedy Algorithms'),
        ('23', 'Backtracking'),
        ('24', 'Sliding Window'),
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/dsa/build',
        'DSA_Complete_Guide.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=1 * inch,
        rightMargin=1 * inch,
        title='Data Structures & Algorithms: A Complete Guide',
        author='DSA Book',
