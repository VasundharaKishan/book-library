...
Backend Design Patterns - PDF Generator
"""
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/backend-patterns/manuscript'
CHAPTER_FOLDERS = [
    '01-what-are-backend-patterns',
    '02-singleton',
    '03-factory-method',
    '04-abstract-factory',
    '05-builder',
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'Backend Design Patterns')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('Backend Design Patterns', styles['BookTitle']))
    ...
    flowables.append(Paragraph(
        'Master GoF Patterns, Architecture Patterns, and Microservices Patterns -- With Java and Python',
        subtitle_style
    ))
    flowables.append(Spacer(1, 2.5 * inch))
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/backend-patterns/build',
        'Backend_Design_Patterns.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=1 * inch,
        rightMargin=1 * inch,
        title='Backend Design Patterns: A Complete Guide',
        author='Backend Design Patterns Book',
        subject='Backend Design Patterns',
    )
