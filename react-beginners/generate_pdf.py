...
React for Beginners: A Friendly Guide - PDF Generator
"""
...
CHAPTER_DIR = '/Users/e141057/Desktop/work/clade_play_area/books/react-beginners/manuscript'
CHAPTER_FOLDERS = [
    '01-what-is-react',
    '02-why-react',
    '03-how-react-works',
    ...
    '24-final-project',
    '25-thinking-in-react',
    '26-keeping-components-pure',
    '27-how-react-renders',
    '28-refs',
    '29-useReducer',
    '30-context',
    '31-custom-hooks',
    '32-typescript-basics',
]
...
def add_page_number(canvas, doc):
    ...
    if page_num > 2:  # Skip cover and TOC first page
        ...
        canvas.drawString(inch, letter[1] - 0.55 * inch, 'React for Beginners: A Friendly Guide')
        canvas.restoreState()
...
def build_cover_page(styles):
    ...
    flowables.append(Paragraph('React for Beginners', styles['BookTitle']))
    flowables.append(Paragraph('A Friendly Guide', styles['BookSubtitle']))
    ...
    flowables.append(Paragraph(
        'Learn React Step by Step — From Zero to Building Real Apps',
        subtitle_style
    ))
    flowables.append(Spacer(1, 0.3 * inch))
    flowables.append(Paragraph(
...
def main():
    output_path = os.path.join(
        '/Users/e141057/Desktop/work/clade_play_area/books/react-beginners/build',
        'React_for_Beginners.pdf'
    )
    ...
    doc = SimpleDocTemplate(
        ...
        leftMargin=1 * inch,
        rightMargin=1 * inch,
        title='React for Beginners: A Friendly Guide',
        author='React for Beginners Book',
